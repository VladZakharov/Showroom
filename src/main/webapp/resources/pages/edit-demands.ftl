    ...
    <div class="col-md-12">
        ...
        <div class="portlet box green">
            ...
            <div class="portlet-body form">
                <!-- BEGIN FORM-->
                <form action="/demands/${demands.id}/edit" id="form_sample_3" class="form-horizontal" method="post">
                    <div class="form-body">
                    ...
                    <div class="form-actions">
                        <div class="row">
                            <div class="col-md-offset-3 col-md-9">
                                ...
                                <button href="/demands/all" type="button" class="btn default">Cancel</button>
                            </div>
                        </div>
                    </div>
                </form>
