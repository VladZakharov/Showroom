    ...
    <div class="col-md-12">
        ...
        <div class="portlet box green">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-gift"></i>Edit car
                </div>
            </div>
            <div class="portlet-body form">
                <!-- BEGIN FORM-->
                <form action="/cars/${car.id}/edit" id="form_sample_3" class="form-horizontal" method="post">
                    <div class="form-body">
                            ...
                            <div class="col-md-4">
                                <select class="form-control select2me" name="brand">
                                    ...
                                    <#list brands as brand>
                                        <option
                                            <#if car.brand?? && car.brand.name == brand.name>
                                                    selected
                                            </#if>
                            ...
                            <div class="col-md-4">
                                <select class="form-control select2me" name="color">
                                    ...
                                    <#list colors as color>
                                        <option
                                            <#if spec.color?? && spec.color.name == color.name>
                                                    selected
                                            </#if>
                            ...
                            <div class="col-md-4">
                                <select class="form-control select2me" name="tc">
                                    ...
                                    <#list conditions as condition>
                                        <option
                                            <#if car.condition?? && car.condition.name == condition.name>
                                                    selected
                                            </#if>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <select class="form-control select2me" name="year">
                                    <#if !car.graduationYear??>
                                        <option value="">Select year...</option>
                                    </#if>
                                    <#list 1970..2016 as year>
                                        <option
                                            <#if car.graduationYear?? && car.graduationYear == year>
                                                    selected
                                            </#if>
